...
#[derive(Debug)]
struct RtcClient<ConnectionState> {
    rtc: Rtc,
...
impl Client {
    ...
    pub async fn send_offer(&mut self) -> Result<SdpMessageType, Error> {
    ...
    pub fn create_answer(&mut self, offer: SdpOffer) -> Result<(), RtcError> {
        //     let answer = self
        //         .rtc
        //         .sdp_api()
        //         .accept_offer(offer)
        ...
        //     Ok(answer)
        // TODO: send the answer using the http client
        todo!()
    }
